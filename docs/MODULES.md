...
| `AnnotationReviewEngine` | Engine | Biznesowa | Czyste przejścia stanu anotacji: propozycja, korekta klasy, usunięcie boksu, akceptacja/odrzucenie klatki. Oddzielone od OCR i UI, bo zasady weryfikacji mogą ewoluować niezależnie. |
