...
class PipelineRun(TimestampMixin, Base):
    ...
    # These two fields describe the profile-wide fallback only. Explicit-only
    # runs keep them NULL; their exact configuration lives in region snapshots.
    ocr_config_hash: Mapped[str | None] = mapped_column(String(64))
